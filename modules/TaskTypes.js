...
export const TASK_TYPES_CONFIG = {
  [TASK_TYPE_KEYS.MOVEMENT]: {
    ...
    extensionElements: [ 'space:Type', 'space:Destination', 'space:TaskAssignment', 'space:TaskAssignmentReached' ], // Keep Type
  ...
  [TASK_TYPE_KEYS.BINDING]: {
    ...
    extensionElements: [ 'space:Type', 'space:TaskAssignment', 'space:TaskAssignmentReached' ], // KEEP Type for task identification
    validationRules: [],
